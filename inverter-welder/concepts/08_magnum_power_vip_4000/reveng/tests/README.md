...
almost all the time around 60V. Only when PWM is set to 0% then the output idle voltage drops to around 5V.

In this document I cover some hardware tests of Pover VIP 400 device to see what is going on.
 ...
 * signal at the bottom is from pin 4 of VT1 element
 ...
 The voltage on pin 4 of VT1 reacts on voltage on the PWM signal (generated by pin 11 of SG3525) and seems to be around 6V greater.
