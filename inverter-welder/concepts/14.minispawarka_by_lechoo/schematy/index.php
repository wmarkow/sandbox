...
$languageStrings = Array(
	...
	"pl" => Array(
		...
		"1 item" => "1 plik",
		"%d items" => "%d pliki/ow",
		"%s is not a subdirectory of the current directory." => "%s nie jest podkatalogiem biezacego katalogu.",
		"File not found: %s" => "Plik nie znaleziony: %s",
		"Illegal characters detected in URL, ignoring." => "Wystapil niepoprawny znak w kodzie HTML - zignorowany.",
		"Illegal path specified, ignoring." => "Niepoprawna sciezka - zignorowana."
	),
